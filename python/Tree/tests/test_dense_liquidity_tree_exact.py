...
class TestDenseLiquidityTreeExact(FloatingPointTestCase):
    ...
    def test_right_leg_only(self):
        ...
        self.assertEqual(int(root.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("8349223596904894021"))  # 2303115199 + 8349223594601778821 = 8349223596904894020 (sol losses 1 wei)
        ...
        self.assertEqual(int(R.token_x_cumulative_earned_per_m_liq),
                         UnsignedDecimal("2747859799935140578"))  # 757991165 + 2747859799177149412 = 2747859799935140577 (sol losses 1 wei)
        self.assertEqual(int(R.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("6996304360355904017"))  # 1929915382 + 6996304358425988634 = 6996304360355904016 (sol losses 1 wei)
        ...
        self.assertEqual(int(RL.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("423248578107618890129"))  # 148929881804 + 423248577958689008325 = 423248578107618890129
        ...
        self.assertEqual(int(RRL.token_x_cumulative_earned_per_m_liq),
                         UnsignedDecimal("154626415017241477"))  # 42651943 + 154626414974589533 = 154626415017241476 (sol losses 1 wei)
        ...
        self.assertEqual(int(RRLL.token_x_cumulative_earned_per_m_liq),
                         UnsignedDecimal("2108117905996538333"))  # 581500584 + 2108117905415037748 = 2108117905996538332 (sol losses 1 wei)
        self.assertEqual(int(RRLL.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("2108117905996538333"))  # 581500584 + 2108117905415037748 = 2108117905996538332 (sol losses 1 wei)
        ...
        self.assertEqual(int(root.token_x_cumulative_earned_per_m_liq),
                         UnsignedDecimal("1355310898622008715"))  # 373601278 + 1354374549470516050 + 936348777891386 = 1355310898622008714 (sol losses 1 wei)
        self.assertEqual(int(root.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("8354995844553968362"))  # 2303115199 + 8349223594601778821 + 5772247649074341 = 8354995844553968361 (sol losses 1 wei)
        ...
        self.assertEqual(int(R.token_x_cumulative_earned_per_m_liq),
                         UnsignedDecimal("2749759536746020655"))  # 757991165 + 2747859799177149412 + 1899736810880077 = 2749759536746020654 (sol losses 1 wei)
        self.assertEqual(int(R.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("7001141265402443372"))  # 1929915382 + 6996304358425988634 + 4836905046539355 = 7001141265402443371 (sol losses 1 wei)
        ...
        self.assertEqual(int(RR.token_x_cumulative_earned_per_m_liq),
                         UnsignedDecimal("2108110694023652836"))  # 581096415 + 2106654304105573173+ 1456389336983247 = 2108110694023652835 (sol losses 1 wei)
        self.assertEqual(int(RR.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("4185908685257423083"))  # 1153837196 + 4183016846975641372 + 2891837127944514 = 4185908685257423082 (sol losses 1 wei)
        ...
        self.assertEqual(int(RL.token_x_cumulative_earned_per_m_liq),
        ...
        self.assertEqual(int(RRL.token_x_cumulative_earned_per_m_liq),
                         UnsignedDecimal("154733312657952739"))  # 42651943 + 154626414974589533 + 106897640711262 = 154733312657952738 (sol losses 1 wei)
        self.assertEqual(int(RRL.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("2201300334794271054"))  # 606784254 + 2199779563978122803 + 1520770209363996 = 2201300334794271053 (sol losses 1 wei)
        ...
        self.assertEqual(int(RRLL.token_x_cumulative_earned_per_m_liq),
                         UnsignedDecimal("2109575308294031902"))  # 581500584 + 2108117905415037748 + 1457402297493569 = 2109575308294031901 (sol losses 1 wei)
        self.assertEqual(int(RRLL.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("2109575308294031902"))  # 581500584 + 2108117905415037748 + 1457402297493569 = 2109575308294031901 (sol losses 1 wei)
        ...
        self.assertEqual(int(root.token_x_cumulative_earned_per_m_liq),
                         UnsignedDecimal("1355504472799662736"))  # 373601278 + 1354374549470516050 + 936348777891386 + 193574177654021 = 1355504472799662735 (sol losses 1 wei)
        self.assertEqual(int(root.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("8356976045440416916"))  # 2303115199 + 8349223594601778821 + 5772247649074341 + 1980200886448553 = 8356976045440416914 (sol losses 2 wei)
        ...
        self.assertEqual(int(root.token_y_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("710730032735"))  # 2 + 710693401861 + 35458749 + 1172122 = 710730032734 (sol losses 1 wei)
        ...
        self.assertEqual(int(R.token_x_cumulative_earned_per_m_liq),
                         UnsignedDecimal("2750152275007241348"))  # 757991165 + 2747859799177149412 + 1899736810880077 + 392738261220692 = 2750152275007241346 (sol losses 2 wei)
        self.assertEqual(int(R.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("7002928263843528708"))  # 1929915382 + 6996304358425988634 + 4836905046539355 + 1786998441085335 = 7002928263843528706 (sol losses 2 wei)
        ...
        self.assertEqual(int(R.token_y_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("552485321387"))  # 1 + 552456845956 + 27563825 + 911603 = 552485321385 (sol losses 2 wei)
        ...
        self.assertEqual(int(RR.token_x_cumulative_earned_per_m_liq),
                         UnsignedDecimal("2108411777738297593"))  # 581096415 + 2106654304105573173+ 1456389336983247 + 301083714644757 = 2108411777738297592 (sol losses 1 wei)
        self.assertEqual(int(RR.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("4186900096861593205"))  # 1153837196 + 4183016846975641372 + 2891837127944514 + 991411604170121 = 4186900096861593203 (sol losses 2 wei)
        ...
        self.assertEqual(int(RR.token_y_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("552009051680"))  # 1 + 551980602776 + 27539135 + 909766 = 552009051678 (sol losses 2 wei)
        ...
        self.assertEqual(int(RRL.token_x_cumulative_earned_per_m_liq),
                         UnsignedDecimal("154755411926283539"))  # 42651943 + 154626414974589533 + 106897640711262 + 22099268330799 = 154755411926283537 (sol losses 2 wei)
        self.assertEqual(int(RRL.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("2202031695485822407"))  # 606784254 + 2199779563978122803 + 1520770209363996 + 731360691551353 = 2202031695485822406 (sol losses 1 wei)
        ...
        self.assertEqual(int(RRL.token_y_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("519122293207"))  # 1 + 519095539054 + 25898463 + 855687 = 519122293205 (sol losses 2 wei)
        ...
        self.assertEqual(int(RRLL.token_x_cumulative_earned_per_m_liq),
                         UnsignedDecimal("2110306406167095653"))  # 581500584 + 2108117905415037748 + 1457402297493569 + 731097873063750 = 2110306406167095651 (sol losses 2 wei)
        self.assertEqual(int(RRLL.token_x_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("2110306406167095653"))  # 581500584 + 2108117905415037748 + 1457402297493569 + 731097873063750 = 2110306406167095651 (sol losses 2 wei)
        ...
        self.assertEqual(int(RRLL.token_y_cumulative_earned_per_m_subtree_liq),
                         UnsignedDecimal("529154884359"))  # 1 + 529127613134 + 26398986 + 872237 = 529154884358 (sol losses 1 wei)
