...
class TestDenseLiquidityTreeSolTruncation(TestCase):
    ...
    def test_root_only(self):
        ...
        self.assertEqual(root.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("38024667284"))
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("38024667284"))
        self.assertEqual(root.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(root.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(root.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("11881018269102163474"))          # 11881018231077496190 + 38024667284 = 11881018269102163474
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("11881018269102163474"))  # 11881018231077496190 + 38024667284 = 11881018269102163474
        self.assertEqual(root.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("13251904"))
        self.assertEqual(root.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("13251904"))
        ...
        self.assertEqual(root.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("11881019661491126559"))           # 11881018269102163474 + 1392388963085 = 11881019661491126559
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("11881019661491126559"))   # 11881018269102163474 + 1392388963085 = 11881019661491126559
        self.assertEqual(root.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("13251905"))
        self.assertEqual(root.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("13251905"))
        ...
        self.assertEqual(root.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2563695146166521368512"))          # 2551814126505030241953 + 11881019661491126559 = 2563695146166521368512
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2563695146166521368512"))  # 2551814126505030241953 + 11881019661491126559 = 2563695146166521368512
        self.assertEqual(root.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("2019821011408"))                   # 2019807759503 + 13251905 = 2019821011408
        self.assertEqual(root.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2019821011408"))           # 2019807759503 + 13251905 = 2019821011408
    ...
    def test_left_leg_only(self):
        ...
        # root
        self.assertEqual(root.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("373601278"))
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2303115199"))
        self.assertEqual(root.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(root.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2"))

        # L
        self.assertEqual(L.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("757991165"))
        self.assertEqual(L.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1929915382"))
        self.assertEqual(L.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(L.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1"))

        # LL
        self.assertEqual(LL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("581096415"))
        self.assertEqual(LL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1153837196"))
        self.assertEqual(LL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1"))

        # LR
        self.assertEqual(LR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("148929881804"))
        self.assertEqual(LR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("148929881804"))
        self.assertEqual(LR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("10"))
        self.assertEqual(LR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("10"))

        # LLR
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("42651943"))
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("606784254"))
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1"))

        # LLRR
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("581500584"))
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("581500584"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("1"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1"))
        ...
        # root
        self.assertEqual(root.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("1354374549844117328"))
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("8349223596904894020"))
        self.assertEqual(root.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("158351473403"))
        self.assertEqual(root.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("710693401863"))

        # L
        self.assertEqual(L.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2747859799935140577"))
        self.assertEqual(L.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("6996304360355904016"))
        self.assertEqual(L.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("219375887"))
        self.assertEqual(L.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("552456845956"))

        # LL
        self.assertEqual(LL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2106654304686669588"))
        self.assertEqual(LL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("4183016848129478568"))
        self.assertEqual(LL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("62008538706"))
        self.assertEqual(LL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("551980602777"))

        # LR
        self.assertEqual(LR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("423248578107618890129"))
        self.assertEqual(LR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("423248578107618890129"))
        self.assertEqual(LR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("2197219781195"))
        self.assertEqual(LR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2197219781195"))

        # LLR
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("154626415017241476"))
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2199779564584907057"))
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("5771781665"))
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("519095539055"))

        # LLRR
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2108117905996538332"))
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2108117905996538332"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("529127613135"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("529127613135"))
        ...
        # root
        self.assertEqual(root.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("1355310898622008714"))
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("8354995844553968361"))
        self.assertEqual(root.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("158359374060"))
        self.assertEqual(root.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("710728860612"))

        # L
        self.assertEqual(L.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2749759536746020654"))
        self.assertEqual(L.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("7001141265402443371"))
        self.assertEqual(L.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("219386832"))
        self.assertEqual(L.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("552484409781"))

        # LL
        self.assertEqual(LL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2108110694023652835"))
        self.assertEqual(LL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("4185908685257423082"))
        self.assertEqual(LL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("62011632404"))
        self.assertEqual(LL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("552008141912"))

        # LR
        self.assertEqual(LR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("423621837838722923425"))
        self.assertEqual(LR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("423621837838722923425"))
        self.assertEqual(LR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("2197359621190"))
        self.assertEqual(LR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2197359621190"))

        # LLR
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("154733312657952738"))
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2201300334794271053"))
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("5772069627"))
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("519121437518"))

        # LLRR
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2109575308294031901"))
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2109575308294031901"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("529154012121"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("529154012121"))
        ...
        # root
        self.assertEqual(root.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("1355504472799662735"))
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("8356976045440416914"))
        self.assertEqual(root.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("158359634767"))
        self.assertEqual(root.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("710730032734"))

        # L
        self.assertEqual(L.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2750152275007241346"))
        self.assertEqual(L.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("7002928263843528706"))
        self.assertEqual(L.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("219387193"))
        self.assertEqual(L.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("552485321384"))

        # LL
        self.assertEqual(LL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2108411777738297592"))
        self.assertEqual(LL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("4186900096861593203"))
        self.assertEqual(LL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("62011734490"))
        self.assertEqual(LL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("552009051678"))

        # LR
        self.assertEqual(LR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("426914215366679462837"))
        self.assertEqual(LR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("426914215366679462837"))
        self.assertEqual(LR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("2197372595215"))
        self.assertEqual(LR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2197372595215"))

        # LLR
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("154755411926283537"))
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2202031695485822406"))
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("5772079129"))
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("519122293205"))

        # LLRR
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2110306406167095651"))
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2110306406167095651"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("529154884358"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("529154884358"))
    ...
    def test_simple_example(self):
        ...
        self.assertEqual(RL.token_x_subtree_borrowed, 42e18)
        self.assertEqual(RL.token_x_cummulative_earned_per_m_liq, 1316476441828)
        self.assertEqual(RL.token_x_cummulative_earned_per_m_subtree_liq, 2303833773200)
    ...
    def test_right_leg_only(self):
        ...
        self.assertEqual(R.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("757991165"))
        self.assertEqual(R.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1929915382"))
        self.assertEqual(R.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(R.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1"))
        ...
        self.assertEqual(RR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("581096415"))
        self.assertEqual(RR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1153837196"))
        self.assertEqual(RR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1"))
        ...
        self.assertEqual(RL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("148929881804"))
        self.assertEqual(RL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("148929881804"))
        self.assertEqual(RL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("10"))
        self.assertEqual(RL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("10"))
        ...
        self.assertEqual(RRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("42651943"))
        self.assertEqual(RRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("606784254"))
        self.assertEqual(RRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1"))
        ...
        self.assertEqual(RRLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("581500584"))
        self.assertEqual(RRLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("581500584"))
        self.assertEqual(RRLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("1"))
        self.assertEqual(RRLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1"))
        ...
        self.assertEqual(root.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("1354374549844117328"))          # 373601278 + 1354374549470516050 = 1354374549844117328
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("8349223596904894020"))  # 2303115199 + 8349223594601778821 = 8349223596904894020
        self.assertEqual(root.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("158351473403"))                 # 0 + 158351473403 = 158351473403
        self.assertEqual(root.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("710693401863"))         # 2 + 710693401861 = 710693401863
        ...
        self.assertEqual(R.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2747859799935140577"))          # 757991165 + 2747859799177149412 = 2747859799935140577
        self.assertEqual(R.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("6996304360355904016"))  # 1929915382 + 6996304358425988634 = 6996304360355904016
        self.assertEqual(R.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("219375887"))                    # 0 + 219375887 = 219375887 = 219375887
        self.assertEqual(R.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("552456845956"))         # 1 + 552456845955 = 552456845956
        ...
        self.assertEqual(RR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2106654304686669588"))          # 581096415 + 2106654304105573173 = 2106654304686669588
        self.assertEqual(RR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("4183016848129478568"))  # 1153837196 + 4183016846975641372 = 4183016848129478568
        self.assertEqual(RR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("62008538706"))                  # 0 + 62008538706 = 62008538706
        self.assertEqual(RR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("551980602777"))         # 1 + 551980602776 = 551980602777
        ...
        self.assertEqual(RL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("423248578107618890129"))          # 148929881804 + 423248577958689008325 = 423248578107618890129
        self.assertEqual(RL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("423248578107618890129"))  # 148929881804 + 423248577958689008325 = 423248578107618890129
        self.assertEqual(RL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("2197219781195"))                  # 10 + 2197219781185 = 2197219781195
        self.assertEqual(RL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2197219781195"))          # 10 + 2197219781185 = 2197219781195
        ...
        self.assertEqual(RRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("154626415017241476"))           # 42651943 + 154626414974589533 = 154626415017241476 (sol losses 1 wei)
        self.assertEqual(RRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2199779564584907057"))  # 606784254 + 2199779563978122803 = 2199779564584907057
        self.assertEqual(RRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("5771781665"))                   # 0 + 5771781665 = 5771781665
        self.assertEqual(RRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("519095539055"))         # 1 + 519095539054 = 519095539055
        ...
        self.assertEqual(RRLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2108117905996538332"))          # 581500584 + 2108117905415037748 = 2108117905996538332
        self.assertEqual(RRLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2108117905996538332"))  # 581500584 + 2108117905415037748 = 2108117905996538332
        self.assertEqual(RRLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("529127613135"))                 # 1 + 529127613134 = 529127613135
        self.assertEqual(RRLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("529127613135"))         # 1 + 529127613134 = 529127613135
        ...
        self.assertEqual(root.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("1355310898622008714"))          # 373601278 + 1354374549470516050 + 936348777891386 = 1355310898622008714
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("8354995844553968361"))  # 2303115199 + 8349223594601778821 + 5772247649074341 = 8354995844553968361
        self.assertEqual(root.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("158359374060"))                 # 0 + 158351473403 + 7900657 = 158359374060
        self.assertEqual(root.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("710728860612"))         # 2 + 710693401861 + 35458749 = 710728860612
        ...
        self.assertEqual(R.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2749759536746020654"))          # 757991165 + 2747859799177149412 + 1899736810880077 = 2749759536746020654
        self.assertEqual(R.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("7001141265402443371"))  # 1929915382 + 6996304358425988634 + 4836905046539355 = 7001141265402443371
        self.assertEqual(R.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("219386832"))                    # 0 + 219375887 + 10945 = 219386832
        self.assertEqual(R.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("552484409781"))         # 1 + 552456845955 + 27563825 = 552484409781
        ...
        self.assertEqual(RR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2108110694023652835"))          # 581096415 + 2106654304105573173+ 1456389336983247 = 2108110694023652835
        self.assertEqual(RR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("4185908685257423082"))  # 1153837196 + 4183016846975641372 + 2891837127944514 = 4185908685257423082
        self.assertEqual(RR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("62011632404"))                  # 0 + 62008538706 + 3093698 = 62011632404
        self.assertEqual(RR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("552008141912"))         # 1 + 551980602776 + 27539135 = 552008141912
        ...
        self.assertEqual(RL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("423621837838722923425"))          # 148929881804 + 423248577958689008325 + 373259731104033296 = 423621837838722923425
        self.assertEqual(RL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("423621837838722923425"))  # 148929881804 + 423248577958689008325 + 373259731104033296 = 423621837838722923425
        self.assertEqual(RL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("2197359621190"))                  # 10 + 2197219781185 + 139839995 = 2197359621190
        self.assertEqual(RL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2197359621190"))          # 10 + 2197219781185 + 139839995 = 2197359621190
        ...
        self.assertEqual(RRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("154733312657952738"))           # 42651943 + 154626414974589533 + 106897640711262 = 154733312657952738
        self.assertEqual(RRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2201300334794271053"))  # 606784254 + 2199779563978122803 + 1520770209363996 = 2201300334794271053
        self.assertEqual(RRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("5772069627"))                   # 0 + 5771781665 + 287962 = 5772069627
        self.assertEqual(RRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("519121437518"))         # 1 + 519095539054 + 25898463 = 519121437518
        ...
        self.assertEqual(RRLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2109575308294031901"))          # 581500584 + 2108117905415037748 + 1457402297493569 = 2109575308294031901
        self.assertEqual(RRLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2109575308294031901"))  # 581500584 + 2108117905415037748 + 1457402297493569 = 2109575308294031901
        self.assertEqual(RRLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("529154012121"))                 # 1 + 529127613134 + 26398986 = 529154012121
        self.assertEqual(RRLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("529154012121"))         # 1 + 529127613134 + 26398986 = 529154012121
        ...
        self.assertEqual(root.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("1355504472799662735"))         # 373601278 + 1354374549470516050 + 936348777891386 + 193574177654021 = 1355504472799662735
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("8356976045440416914")) # 2303115199 + 8349223594601778821 + 5772247649074341 + 1980200886448553 = 8356976045440416914
        self.assertEqual(root.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("158359634767"))                # 0 + 158351473403 + 7900657 + 260707 = 158359634767
        self.assertEqual(root.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("710730032734"))        # 2 + 710693401861 + 35458749 + 1172122 = 710730032734
        ...
        self.assertEqual(R.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2750152275007241346"))          # 757991165 + 2747859799177149412 + 1899736810880077 + 392738261220692 = 2750152275007241346
        self.assertEqual(R.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("7002928263843528706"))  # 1929915382 + 6996304358425988634 + 4836905046539355 + 1786998441085335 = 7002928263843528706
        self.assertEqual(R.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("219387193"))                    # 0 + 219375887 + 10945 + 361 = 219387193
        self.assertEqual(R.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("552485321384"))         # 1 + 552456845955 + 27563825 + 911603 = 552485321384
        ...
        self.assertEqual(RR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2108411777738297592"))          # 581096415 + 2106654304105573173+ 1456389336983247 + 301083714644757 = 2108411777738297592
        self.assertEqual(RR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("4186900096861593203"))  # 1153837196 + 4183016846975641372 + 2891837127944514 + 991411604170121 = 4186900096861593203
        self.assertEqual(RR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("62011734490"))                  # 0 + 62008538706 + 3093698 + 102086 = 62011734490
        self.assertEqual(RR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("552009051678"))         # 1 + 551980602776 + 27539135 + 909766 = 552009051678
        ...
        self.assertEqual(RL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("426914215366679462837"))          # 148929881804 + 423248577958689008325 + 373259731104033296 + 3292377527956539412 = 426914215366679462837
        self.assertEqual(RL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("426914215366679462837"))  # 148929881804 + 423248577958689008325 + 373259731104033296 + 3292377527956539412 = 426914215366679462837
        self.assertEqual(RL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("2197372595215"))                  # 10 + 2197219781185 + 139839995 + 12974025 = 2197372595215
        self.assertEqual(RL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2197372595215"))          # 10 + 2197219781185 + 139839995 + 12974025 = 2197372595215
        ...
        self.assertEqual(RRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("154755411926283537"))           # 42651943 + 154626414974589533 + 106897640711262 + 22099268330799 = 154755411926283537
        self.assertEqual(RRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2202031695485822406"))  # 606784254 + 2199779563978122803 + 1520770209363996 + 731360691551353 = 2202031695485822406
        self.assertEqual(RRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("5772079129"))                   # 0 + 5771781665 + 287962 + 9502 = 5772079129
        self.assertEqual(RRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("519122293205"))         # 1 + 519095539054 + 25898463 + 855687 = 519122293205
        ...
        self.assertEqual(RRLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2110306406167095651"))          # 581500584 + 2108117905415037748 + 1457402297493569 + 731097873063750 = 2110306406167095651
        self.assertEqual(RRLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2110306406167095651"))  # 581500584 + 2108117905415037748 + 1457402297493569 + 731097873063750 = 2110306406167095651
        self.assertEqual(RRLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("529154884358"))                 # 1 + 529127613134 + 26398986 + 872237 = 529154884358
        self.assertEqual(RRLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("529154884358"))         # 1 + 529127613134 + 26398986 + 872237 = 529154884358
    ...
    def test_complete_tree(self):
        ...
        liq_tree.add_t_liq(LiqRange(12, 13), UnsignedDecimal("5556478634723908752323756"), UnsignedDecimal("28635482364798629384e18"), UnsignedDecimal("83764587364859348795634987e6"))
        liq_tree.add_m_liq(LiqRange(14, 15), UnsignedDecimal("54534789284573456239862722"))  # RRR
        liq_tree.add_t_liq(LiqRange(14, 15), UnsignedDecimal("34534789284573456239862722"), UnsignedDecimal("27364527863428346239867e18"), UnsignedDecimal("9834657827356482367482369e6"))
        ...
        liq_tree.add_t_liq(LiqRange(11, 11), UnsignedDecimal("3254647578679689678567456"), UnsignedDecimal("287346234623487923642786e18"), UnsignedDecimal("827364826734823748963e6"))
        ...
        # borrowed_x
        self.assertEqual(root.token_x_borrowed, UnsignedDecimal("122757244859000000000000000000"))

        self.assertEqual(L.token_x_borrowed, UnsignedDecimal("4564946112436545000000000000000000"))
        self.assertEqual(R.token_x_borrowed, UnsignedDecimal("4214226187000000000000000000"))

        self.assertEqual(LL.token_x_borrowed, UnsignedDecimal("28591083251822194000000000000000000"))
        self.assertEqual(LR.token_x_borrowed, UnsignedDecimal("872538470624167989000000000456468745"))
        self.assertEqual(RL.token_x_borrowed, UnsignedDecimal("11350238408160809000000000000000000"))
        self.assertEqual(RR.token_x_borrowed, UnsignedDecimal("498723597863764293000000000000000000"))

        self.assertEqual(LLL.token_x_borrowed, UnsignedDecimal("45623798462966929913344000000000000000000"))
        self.assertEqual(LLR.token_x_borrowed, UnsignedDecimal("298364785638480072406864000000000456468745"))
        self.assertEqual(LRL.token_x_borrowed, UnsignedDecimal("27364762534827634534656283000000000000000000"))
        self.assertEqual(LRR.token_x_borrowed, UnsignedDecimal("7653642903472903784290347000000000000000000"))
        self.assertEqual(RLL.token_x_borrowed, UnsignedDecimal("23452367423432458653826000000000000000000"))
        self.assertEqual(RLR.token_x_borrowed, UnsignedDecimal("2765723642783492000000000000000000"))
        self.assertEqual(RRL.token_x_borrowed, UnsignedDecimal("28635482365337910060000000000000000000"))
        self.assertEqual(RRR.token_x_borrowed, UnsignedDecimal("27364527863428346239867000000000000000000"))

        self.assertEqual(LLLL.token_x_borrowed, UnsignedDecimal("5730994510532853000000000000000000"))
        self.assertEqual(LLLR.token_x_borrowed, UnsignedDecimal("346456348776251331000000000456468745"))
        self.assertEqual(LLRL.token_x_borrowed, UnsignedDecimal("82735476982561720575720000000000000000000"))
        self.assertEqual(LLRR.token_x_borrowed, UnsignedDecimal("2367452364752903485729403875000000000000000000"))
        self.assertEqual(LRLL.token_x_borrowed, UnsignedDecimal("236452378374761357390655000000000000000000"))
        self.assertEqual(LRLR.token_x_borrowed, UnsignedDecimal("8374278364628364000000000000000000"))
        self.assertEqual(LRRL.token_x_borrowed, UnsignedDecimal("3456457409582626000000000000000000"))
        self.assertEqual(LRRR.token_x_borrowed, UnsignedDecimal("236542867349237498000000000000000000"))
        self.assertEqual(RLLL.token_x_borrowed, UnsignedDecimal("51427634238746298454880156000000000000000000"))
        self.assertEqual(RLLR.token_x_borrowed, UnsignedDecimal("634529836428376523000000000000000000"))
        self.assertEqual(RLRL.token_x_borrowed, UnsignedDecimal("1212312318064122113000000000000000000"))
        self.assertEqual(RLRR.token_x_borrowed, UnsignedDecimal("287346234623487923642786000000000000000000"))
        self.assertEqual(RRLL.token_x_borrowed, UnsignedDecimal("2837427354234552837898000000000000000000"))
        self.assertEqual(RRLR.token_x_borrowed, UnsignedDecimal("82635472634823674000000000000000000"))
        self.assertEqual(RRRL.token_x_borrowed, UnsignedDecimal("23645278463153819232000000000000000000"))
        self.assertEqual(RRRR.token_x_borrowed, UnsignedDecimal("37465276342938487000000000000000000"))

        # subtree_borrowed_x
        self.assertEqual(root.token_x_subtree_borrowed, UnsignedDecimal("2454902637693472541111720750000000001369406235"))

        self.assertEqual(L.token_x_subtree_borrowed, UnsignedDecimal("2403133948136918240527296488000000001369406235"))
        self.assertEqual(R.token_x_subtree_borrowed, UnsignedDecimal("51768689556554177827179403000000000000000000"))

        self.assertEqual(LL.token_x_subtree_borrowed, UnsignedDecimal("2367879089194765920990906181000000000912937490"))
        self.assertEqual(LR.token_x_subtree_borrowed, UnsignedDecimal("35254858937587373423953762000000000456468745"))
        self.assertEqual(RL.token_x_subtree_borrowed, UnsignedDecimal("51738434701751335380619705000000000000000000"))
        self.assertEqual(RR.token_x_subtree_borrowed, UnsignedDecimal("30254854802838232333511000000000000000000"))

        self.assertEqual(LLL.token_x_subtree_borrowed, UnsignedDecimal("45624150650310216697528000000000456468745"))
        self.assertEqual(LLR.token_x_subtree_borrowed, UnsignedDecimal("2367833465015524527522386459000000000456468745"))
        self.assertEqual(LRL.token_x_subtree_borrowed, UnsignedDecimal("27601214921576674256675302000000000000000000"))
        self.assertEqual(LRR.token_x_subtree_borrowed, UnsignedDecimal("7653643143472228543110471000000000000000000"))
        self.assertEqual(RLL.token_x_subtree_borrowed, UnsignedDecimal("51451087240699567341910505000000000000000000"))
        self.assertEqual(RLR.token_x_subtree_borrowed, UnsignedDecimal("287347449701529630548391000000000000000000"))
        self.assertEqual(RRL.token_x_subtree_borrowed, UnsignedDecimal("2866145472072525571632000000000000000000"))
        self.assertEqual(RRR.token_x_subtree_borrowed, UnsignedDecimal("27388210607167842997586000000000000000000"))

        self.assertEqual(LLLL.token_x_subtree_borrowed, UnsignedDecimal("5730994510532853000000000000000000"))
        self.assertEqual(LLLR.token_x_subtree_borrowed, UnsignedDecimal("346456348776251331000000000456468745"))
        self.assertEqual(LLRL.token_x_subtree_borrowed, UnsignedDecimal("82735476982561720575720000000000000000000"))
        self.assertEqual(LLRR.token_x_subtree_borrowed, UnsignedDecimal("2367452364752903485729403875000000000000000000"))
        self.assertEqual(LRLL.token_x_subtree_borrowed, UnsignedDecimal("236452378374761357390655000000000000000000"))
        self.assertEqual(LRLR.token_x_subtree_borrowed, UnsignedDecimal("8374278364628364000000000000000000"))
        self.assertEqual(LRRL.token_x_subtree_borrowed, UnsignedDecimal("3456457409582626000000000000000000"))
        self.assertEqual(LRRR.token_x_subtree_borrowed, UnsignedDecimal("236542867349237498000000000000000000"))
        self.assertEqual(RLLL.token_x_subtree_borrowed, UnsignedDecimal("51427634238746298454880156000000000000000000"))
        self.assertEqual(RLLR.token_x_subtree_borrowed, UnsignedDecimal("634529836428376523000000000000000000"))
        self.assertEqual(RLRL.token_x_subtree_borrowed, UnsignedDecimal("1212312318064122113000000000000000000"))
        self.assertEqual(RLRR.token_x_subtree_borrowed, UnsignedDecimal("287346234623487923642786000000000000000000"))
        self.assertEqual(RRLL.token_x_subtree_borrowed, UnsignedDecimal("2837427354234552837898000000000000000000"))
        self.assertEqual(RRLR.token_x_subtree_borrowed, UnsignedDecimal("82635472634823674000000000000000000"))
        self.assertEqual(RRRL.token_x_subtree_borrowed, UnsignedDecimal("23645278463153819232000000000000000000"))
        self.assertEqual(RRRR.token_x_subtree_borrowed, UnsignedDecimal("37465276342938487000000000000000000"))

        # borrowed_y
        self.assertEqual(root.token_y_borrowed, UnsignedDecimal("111746265029000000"))

        self.assertEqual(L.token_y_borrowed, UnsignedDecimal("168910846992000000"))
        self.assertEqual(R.token_y_borrowed, UnsignedDecimal("20158676903000000"))

        self.assertEqual(LL.token_y_borrowed, UnsignedDecimal("1330115070330000000"))
        self.assertEqual(LR.token_y_borrowed, UnsignedDecimal("25629380814000000"))
        self.assertEqual(RL.token_y_borrowed, UnsignedDecimal("978614737019690000000"))
        self.assertEqual(RR.token_y_borrowed, UnsignedDecimal("7856675879087000000"))

        self.assertEqual(LLL.token_y_borrowed, UnsignedDecimal("8725348768599465892504400000"))
        self.assertEqual(LLR.token_y_borrowed, UnsignedDecimal("3465873661686981218000000"))
        self.assertEqual(LRL.token_y_borrowed, UnsignedDecimal("56736409827636032519000000"))
        self.assertEqual(LRR.token_y_borrowed, UnsignedDecimal("7834626734902734902368000000"))
        self.assertEqual(RLL.token_y_borrowed, UnsignedDecimal("9834787362493137985000000"))
        self.assertEqual(RLR.token_y_borrowed, UnsignedDecimal("98576798364725367423000000"))
        self.assertEqual(RRL.token_y_borrowed, UnsignedDecimal("83764587364859345003508901000000"))
        self.assertEqual(RRR.token_y_borrowed, UnsignedDecimal("9834657827356482367482369000000"))

        self.assertEqual(LLLL.token_y_borrowed, UnsignedDecimal("76196798741476175000000"))
        self.assertEqual(LLLR.token_y_borrowed, UnsignedDecimal("26734872634892655597150111000000"))
        self.assertEqual(LLRL.token_y_borrowed, UnsignedDecimal("763467253680744840679549000000"))
        self.assertEqual(LLRR.token_y_borrowed, UnsignedDecimal("987349053045739487000000"))
        self.assertEqual(LRLL.token_y_borrowed, UnsignedDecimal("984764582781001178332000000"))
        self.assertEqual(LRLR.token_y_borrowed, UnsignedDecimal("8763867548273647826000000"))
        self.assertEqual(LRRL.token_y_borrowed, UnsignedDecimal("8726347825634871839691000000"))
        self.assertEqual(LRRR.token_y_borrowed, UnsignedDecimal("798647852364627983000000"))
        self.assertEqual(RLLL.token_y_borrowed, UnsignedDecimal("74986238502927037000000"))
        self.assertEqual(RLLR.token_y_borrowed, UnsignedDecimal("868746576834678534000000"))
        self.assertEqual(RLRL.token_y_borrowed, UnsignedDecimal("3423423619393235000000"))
        self.assertEqual(RLRR.token_y_borrowed, UnsignedDecimal("827364826734823748963000000"))
        self.assertEqual(RRLL.token_y_borrowed, UnsignedDecimal("73649082374024158406167000000"))
        self.assertEqual(RRLR.token_y_borrowed, UnsignedDecimal("2387642836423689768000000"))
        self.assertEqual(RRRL.token_y_borrowed, UnsignedDecimal("3542359995424161000000"))
        self.assertEqual(RRRR.token_y_borrowed, UnsignedDecimal("23984623847623867000000"))

        # subtree_borrowed_y
        self.assertEqual(root.token_y_subtree_borrowed, UnsignedDecimal("121198515219146561028675018400000"))

        self.assertEqual(L.token_y_subtree_borrowed, UnsignedDecimal("27524681804831584915445899400000"))
        self.assertEqual(R.token_y_subtree_borrowed, UnsignedDecimal("93673833414314864366964090000000"))

        self.assertEqual(LL.token_y_subtree_borrowed, UnsignedDecimal("27507069766762843492989374400000"))
        self.assertEqual(LR.token_y_subtree_borrowed, UnsignedDecimal("17612038068572511609533000000"))
        self.assertEqual(RL.token_y_subtree_borrowed, UnsignedDecimal("936724547315736272867000000"))
        self.assertEqual(RR.token_y_subtree_borrowed, UnsignedDecimal("93672896689767528472014320000000"))

        self.assertEqual(LLL.token_y_subtree_borrowed, UnsignedDecimal("26743598059858053804518790400000"))
        self.assertEqual(LLR.token_y_subtree_borrowed, UnsignedDecimal("763471706903459573400254000000"))
        self.assertEqual(LRL.token_y_subtree_borrowed, UnsignedDecimal("1050264860156910858677000000"))
        self.assertEqual(LRR.token_y_subtree_borrowed, UnsignedDecimal("16561773208389971370042000000"))
        self.assertEqual(RLL.token_y_subtree_borrowed, UnsignedDecimal("10778520177830743556000000"))
        self.assertEqual(RLR.token_y_subtree_borrowed, UnsignedDecimal("925945048523168509621000000"))
        self.assertEqual(RRL.token_y_subtree_borrowed, UnsignedDecimal("83838238834876205585604836000000"))
        self.assertEqual(RRR.token_y_subtree_borrowed, UnsignedDecimal("9834657854883466210530397000000"))

        self.assertEqual(LLLL.token_y_subtree_borrowed, UnsignedDecimal("76196798741476175000000"))
        self.assertEqual(LLLR.token_y_subtree_borrowed, UnsignedDecimal("26734872634892655597150111000000"))
        self.assertEqual(LLRL.token_y_subtree_borrowed, UnsignedDecimal("763467253680744840679549000000"))
        self.assertEqual(LLRR.token_y_subtree_borrowed, UnsignedDecimal("987349053045739487000000"))
        self.assertEqual(LRLL.token_y_subtree_borrowed, UnsignedDecimal("984764582781001178332000000"))
        self.assertEqual(LRLR.token_y_subtree_borrowed, UnsignedDecimal("8763867548273647826000000"))
        self.assertEqual(LRRL.token_y_subtree_borrowed, UnsignedDecimal("8726347825634871839691000000"))
        self.assertEqual(LRRR.token_y_subtree_borrowed, UnsignedDecimal("798647852364627983000000"))
        self.assertEqual(RLLL.token_y_subtree_borrowed, UnsignedDecimal("74986238502927037000000"))
        self.assertEqual(RLLR.token_y_subtree_borrowed, UnsignedDecimal("868746576834678534000000"))
        self.assertEqual(RLRL.token_y_subtree_borrowed, UnsignedDecimal("3423423619393235000000"))
        self.assertEqual(RLRR.token_y_subtree_borrowed, UnsignedDecimal("827364826734823748963000000"))
        self.assertEqual(RRLL.token_y_subtree_borrowed, UnsignedDecimal("73649082374024158406167000000"))
        self.assertEqual(RRLR.token_y_subtree_borrowed, UnsignedDecimal("2387642836423689768000000"))
        self.assertEqual(RRRL.token_y_subtree_borrowed, UnsignedDecimal("3542359995424161000000"))
        self.assertEqual(RRRR.token_y_subtree_borrowed, UnsignedDecimal("23984623847623867000000"))

        # token_x_cummulative_earned_per_m_liq
        self.assertEqual(root.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("1653162341"))

        self.assertEqual(L.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("1968034923387"))
        self.assertEqual(R.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("53197209"))

        self.assertEqual(LL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("1537875992445232346"))
        self.assertEqual(LR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("363545476413679861713"))
        self.assertEqual(RL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("141356179733701"))
        self.assertEqual(RR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("61732151382143711"))

        self.assertEqual(LLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("2556757494839963014198184"))
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("371158797429650858973438625"))
        self.assertEqual(LRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("60841441341419381047595034241085"))
        self.assertEqual(LRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("3189508411491199598333431314"))
        self.assertEqual(RLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("657996725303326136999"))
        self.assertEqual(RLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("223727062042489"))
        self.assertEqual(RRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("29115133709213782165"))
        self.assertEqual(RRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("3856709189487099165901"))

        self.assertEqual(LLLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("889700619080860150"))
        self.assertEqual(LLLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("30393719776417661690"))
        self.assertEqual(LLRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("159213596840619244523447699163"))
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("1051376974879620344655023882438"))
        self.assertEqual(LRLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("1537891441852978794"))
        self.assertEqual(LRRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("31935758833446278128768039723"))
        self.assertEqual(RLLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("236616939696375723"))
        self.assertEqual(RLRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RRLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("5767677373168060851383"))
        self.assertEqual(RRLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RRRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("6665049232753208950"))
        self.assertEqual(RRRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))

        # token_x_cummulative_earned_per_m_subtree_liq
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("43756288901278965565289120"))

        self.assertEqual(L.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("114172069341113006721615069516"))
        self.assertEqual(R.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("923073628282275460400546"))

        self.assertEqual(LL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("126975792932608136142575516378"))
        self.assertEqual(LR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("14689030881642935495954673055"))
        self.assertEqual(RL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1077791623755590749427001"))
        self.assertEqual(RR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("3744954689799430215251"))

        self.assertEqual(LLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2556777231614922263512088"))
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2945529310733483531304171330809"))
        self.assertEqual(LRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("61367157725965120112844741263941"))
        self.assertEqual(LRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("3189508511506300233910914258"))
        self.assertEqual(RLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1443549229249734665667944"))
        self.assertEqual(RLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("23244332771593818172928"))
        self.assertEqual(RRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2914154110846149087494"))
        self.assertEqual(RRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("3860046994395227474433"))

        self.assertEqual(LLLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("889700619080860150"))
        self.assertEqual(LLLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("30393719776417661690"))
        self.assertEqual(LLRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("159213596840619244523447699163"))
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1051376974879620344655023882438"))
        self.assertEqual(LRLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1537891441852978794"))
        self.assertEqual(LRRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("31935758833446278128768039723"))
        self.assertEqual(RLLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("236616939696375723"))
        self.assertEqual(RLRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("5767677373168060851383"))
        self.assertEqual(RRLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("6665049232753208950"))
        self.assertEqual(RRRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))

        # token_y_cummulative_earned_per_m_liq
        self.assertEqual(root.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))

        self.assertEqual(L.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("82"))
        self.assertEqual(R.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))

        self.assertEqual(LL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("670"))
        self.assertEqual(LR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("39"))
        self.assertEqual(RL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("197"))
        self.assertEqual(RR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("9"))

        self.assertEqual(LLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("4747990803139"))
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("41865270006"))
        self.assertEqual(LRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("1224894367084578"))
        self.assertEqual(LRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("31703181193601"))
        self.assertEqual(RLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("2679359"))
        self.assertEqual(RLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("77430742"))
        self.assertEqual(RRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("826996583538488"))
        self.assertEqual(RRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("13459135450531"))

        self.assertEqual(LLLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("109425756"))
        self.assertEqual(LLLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("22774163335023745"))
        self.assertEqual(LLRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("14266182294798018313"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("42518327403210687"))
        self.assertEqual(LRLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("37701268286368"))
        self.assertEqual(LRRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("452159061"))
        self.assertEqual(RLLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("6488"))
        self.assertEqual(RLRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RRLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("1453692415004"))
        self.assertEqual(RRLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RRRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("9695"))
        self.assertEqual(RRRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))

        # token_y_cummulative_earned_per_m_subtree_liq
        self.assertEqual(root.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("20976473812693"))

        self.assertEqual(L.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("12697937271018899"))
        self.assertEqual(R.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("16218714968180"))

        self.assertEqual(LL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("14323023895032874"))
        self.assertEqual(LR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("71254575045205"))
        self.assertEqual(RL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("189479572"))
        self.assertEqual(RR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("112588600574925"))

        self.assertEqual(LLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("14552811706670570"))
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("9222191117511089"))
        self.assertEqual(LRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("22674390484203729"))
        self.assertEqual(LRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("67017984988846"))
        self.assertEqual(RLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("2936467"))
        self.assertEqual(RLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("727317315"))
        self.assertEqual(RRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("827723734665148"))
        self.assertEqual(RRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("13459135488203"))

        self.assertEqual(LLLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("109425756"))
        self.assertEqual(LLLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("22774163335023745"))
        self.assertEqual(LLRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("14266182294798018313"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("42518327403210687"))
        self.assertEqual(LRLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("37701268286368"))
        self.assertEqual(LRRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("452159061"))
        self.assertEqual(RLLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("6488"))
        self.assertEqual(RLRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("1453692415004"))
        self.assertEqual(RRLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("9695"))
        self.assertEqual(RRRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
