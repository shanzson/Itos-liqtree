...
class TestDenseLiquidityTreeSolTruncation(TestCase):
    ...
    def test_complete_tree(self):
        ...
        liq_tree.add_m_liq(UnsignedDecimal(""))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("")
        liq_tree.remove_m_liq(UnsignedDecimal(""))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("")
        liq_tree.add_t_liq(UnsignedDecimal(""), UnsignedDecimal(""), UnsignedDecimal(""))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("")
        liq_tree.remove_t_liq(UnsignedDecimal(""), UnsignedDecimal(""), UnsignedDecimal(""))
        ...
        # LiqRange(1, 4)
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("345")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("346343")
        liq_tree.add_m_liq(UnsignedDecimal("23423"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("3634")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("2342")
        liq_tree.remove_m_liq(UnsignedDecimal("34634"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("2342")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("453")
        liq_tree.add_t_liq(UnsignedDecimal("3463"), UnsignedDecimal("3463e18"), UnsignedDecimal("234234e6"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("2342")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("234")
        liq_tree.remove_t_liq(UnsignedDecimal("2342"), UnsignedDecimal("34634e18"), UnsignedDecimal("45345e6"))

        # LiqRange(1, 5)
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("46")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("3453")
        liq_tree.add_m_liq(UnsignedDecimal("2342"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("3463")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("3453")
        liq_tree.remove_m_liq(UnsignedDecimal("363456"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("423")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("5645")
        liq_tree.add_t_liq(UnsignedDecimal("4564"), UnsignedDecimal("234e18"), UnsignedDecimal("23e6"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("3423")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("2354")
        liq_tree.remove_t_liq(UnsignedDecimal("2342"), UnsignedDecimal("1e18"), UnsignedDecimal("3e6"))

        # LiqRange(1, 6)
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("345345")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("56457")
        liq_tree.add_m_liq(UnsignedDecimal("45645"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("345345")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("356756")
        liq_tree.remove_m_liq(UnsignedDecimal("45645"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("345346")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("745745")
        liq_tree.add_t_liq(UnsignedDecimal("64564"), UnsignedDecimal("4534"), UnsignedDecimal("5e6"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("2342")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("2342")
        liq_tree.remove_t_liq(UnsignedDecimal("234235"), UnsignedDecimal("23452e18"), UnsignedDecimal("4e6"))

        # LiqRange(1, 7)
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("45745645")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("46")
        liq_tree.add_m_liq(UnsignedDecimal("457467"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("3453")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("345346")
        liq_tree.remove_m_liq(UnsignedDecimal("73345"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("345345")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("56756")
        liq_tree.add_t_liq(UnsignedDecimal("6357457457"), UnsignedDecimal("456468745"), UnsignedDecimal("3453e6"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("68567")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("3467")
        liq_tree.remove_t_liq(UnsignedDecimal("3634534"), UnsignedDecimal("3453463e18"), UnsignedDecimal("34534e6"))

        # LiqRange(1, 8)
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("56457")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("456456")
        liq_tree.add_m_liq(UnsignedDecimal("3465346"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("343")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("3453746")
        liq_tree.remove_m_liq(UnsignedDecimal("756756"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("57457")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("45346346")
        liq_tree.add_t_liq(UnsignedDecimal("23424"), UnsignedDecimal("223423e18"), UnsignedDecimal("34634534e6"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("23423")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("34634")
        liq_tree.remove_t_liq(UnsignedDecimal("345345"), UnsignedDecimal("23423e18"), UnsignedDecimal("3434e6"))

        # LiqRange(1, 9)
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("3453")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("3573")
        liq_tree.add_m_liq(UnsignedDecimal("345345"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("45745")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("4523")
        liq_tree.remove_m_liq(UnsignedDecimal("34534"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("34534")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("6745674")
        liq_tree.add_t_liq(UnsignedDecimal("573534"), UnsignedDecimal("2342354e18"), UnsignedDecimal("3453453e6"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("234234")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("64563453")
        liq_tree.remove_t_liq(UnsignedDecimal("34535754"), UnsignedDecimal("3453467435e18"), UnsignedDecimal("4564e6"))

        # LiqRange(1, 10)
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("457457")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("4534534")
        liq_tree.add_m_liq(UnsignedDecimal("34534634"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("34534")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("47574")
        liq_tree.remove_m_liq(UnsignedDecimal("4574574"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("6745674")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("34525")
        liq_tree.add_t_liq(UnsignedDecimal("3453453"), UnsignedDecimal("5645634523e18"), UnsignedDecimal("46346534e6"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("345357")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("756745")
        liq_tree.remove_t_liq(UnsignedDecimal("345346475"), UnsignedDecimal("745645e18"), UnsignedDecimal("78564564e6"))

        # LiqRange(1, 11)
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("457457")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("4434524")
        liq_tree.add_m_liq(UnsignedDecimal("3453453467"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("35756785685")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("5664564")
        liq_tree.remove_m_liq(UnsignedDecimal("345346346"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("234235")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("6347356")
        liq_tree.add_t_liq(UnsignedDecimal("57463"), UnsignedDecimal("34634563e18"), UnsignedDecimal("453463e6"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("34524")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("2342345")
        liq_tree.remove_t_liq(UnsignedDecimal("634634"), UnsignedDecimal("453576353e18"), UnsignedDecimal("5734534e6"))

        # LiqRange(1, 12)
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("3423423")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("3453456")
        liq_tree.add_m_liq(UnsignedDecimal("4564574"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("345245")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("234235")
        liq_tree.remove_m_liq(UnsignedDecimal("4574564"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("2342342")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("6345634")
        liq_tree.add_t_liq(UnsignedDecimal("34634567"), UnsignedDecimal("23424e18"), UnsignedDecimal("3453464e6"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("345345")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("234235")
        liq_tree.remove_t_liq(UnsignedDecimal("4564564"), UnsignedDecimal("2342342e18"), UnsignedDecimal("456456e6"))

        # LiqRange(1, 13)
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("456457")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("456457")
        liq_tree.add_m_liq(UnsignedDecimal("567568"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("567567")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("97867")
        liq_tree.remove_m_liq(UnsignedDecimal("9785"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("67u758")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("35645674")
        liq_tree.add_t_liq(UnsignedDecimal("235363565"), UnsignedDecimal("234534635e18"), UnsignedDecimal("456745643e6"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("345346")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("45674565")
        liq_tree.remove_t_liq(UnsignedDecimal("4545345"), UnsignedDecimal("34535635e18"), UnsignedDecimal("7564353e6"))
        ...
        liq_tree.add_m_liq(UnsignedDecimal("357635634"))
        ...
        liq_tree.remove_m_liq(UnsignedDecimal("23425346456"))
        ...
        liq_tree.add_t_liq(UnsignedDecimal("35235235"), UnsignedDecimal("346356343e18"), UnsignedDecimal("234265e6"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("2342456")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("3563463")
        liq_tree.remove_t_liq(UnsignedDecimal("234235"), UnsignedDecimal("4564565e18"), UnsignedDecimal("4564563452e6"))

        # LiqRange(1, 15)
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("234234")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("2463634534563")
        liq_tree.add_m_liq(UnsignedDecimal("34634636"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("1234245346")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("3453453")
        liq_tree.remove_m_liq(UnsignedDecimal("34534636"))
        liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("3463463")
        liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("234523452")
        liq_tree.add_t_liq(UnsignedDecimal("234534534"), UnsignedDecimal("1234235235e18"), UnsignedDecimal("23423456346e6"))
        ...
        liq_tree.remove_t_liq(UnsignedDecimal("2342352356"), UnsignedDecimal("3465343e18"), UnsignedDecimal("3562342346e6"))
        ...
        # liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("")
        # liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("")
        # liq_tree.add_t_liq(UnsignedDecimal(""), UnsignedDecimal(""))
        # liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("")
        # liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("")
        # liq_tree.remove_t_liq(UnsignedDecimal(""), UnsignedDecimal(""))
        #
        # # LiqRange(2, 3)
        # liq_tree.token_x_fee_rate_snapshot += UnsignedDecimal("")
        # liq_tree.token_y_fee_rate_snapshot += UnsignedDecimal("")
