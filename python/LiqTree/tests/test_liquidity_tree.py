...
class TestLiquidityTree(TestCase):
    ...
    def test_adding_m_liq_left_leg_only(self):
        ...
        self.assertEqual(LLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(LLRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))

        # token_x_cummulative_earned_per_m_subtree_liq
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(L.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(LLRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(LLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(LLRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(L.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(LLRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
    ...
    def test_adding_m_liq_right_leg_only(self):
        ...
        # token_x_cummulative_earned_per_m_liq
        self.assertEqual(root.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(R.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))

        # token_x_cummulative_earned_per_m_subtree_liq
        self.assertEqual(root.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(R.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(RL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))

        # token_y_cummulative_earned_per_m_subtree_liq
        self.assertEqual(root.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(R.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
    ...
    def test_adding_m_liq_left_and_right_leg_stopping_below_peak(self):
        ...
        self.assertEqual(R.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RRLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RRLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RRRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(R.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(RRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RRLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RRLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(RRRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(R.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RLRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(RRRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
    ...
    def test_adding_m_liq_left_leg_lower_than_right_leg(self):
        ...
        self.assertEqual(L.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(L.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(L.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(L.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
    ...
    def test_adding_m_liq_right_leg_lower_than_left_leg(self):
        ...
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLR.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRRL.token_x_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(LLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLR.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRRL.token_x_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLR.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        self.assertEqual(LRRL.token_y_cummulative_earned_per_m_liq, UnsignedDecimal("0"))
        ...
        self.assertEqual(LLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LLRR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRLR.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
        self.assertEqual(LRRL.token_y_cummulative_earned_per_m_subtree_liq, UnsignedDecimal("0"))
